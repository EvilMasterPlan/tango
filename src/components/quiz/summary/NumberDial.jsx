...
// the consumer free to center it in whatever space it sits.
export function NumberDial({ value, hideLeadingZeros = false }) {
  ...
  // digits like the hundreds in "003") are either dimmed or skipped
  // entirely, same convention as a car odometer. A digit only qualifies
  ...
  return (
    // The digits themselves render as individually-animated reels that
    // are aria-hidden — this label is the one place the actual value is
