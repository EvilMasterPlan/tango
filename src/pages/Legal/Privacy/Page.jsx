...
export function LegalPrivacyPage() {
  return (
    <>
      <Helmet>
        <title>Tango Tanuki - Privacy Policy</title>
      </Helmet>
      <div className="legal-page">
        <div className="legal-page__inner">
          ...
          <h1 className="legal-page__title">Tango Tanuki Privacy Policy</h1>
          <p className="legal-page__updated">Last updated: September 11, 2026</p>

          <p>
            Your privacy is important to us. It is Overmind Labs's policy to respect your privacy and comply
            with any applicable law and regulation regarding any personal information we may collect about
            you, including across our website, https://evilmasterplan.github.io/tango, and other sites we
            own and operate.
          </p>
          <p>
          ...
          <p>This policy is effective as of September 11, 2026.</p>
          ...
          <p>
            We may ask for personal information — for example, when you create an account or when you
            contact us — which may include email or transaction data:
          </p>
          <p>
          ...
          <p>
            ...
            passwords associated with accessing your personal information and accounts are secure,
            confidential and not identical to a password associated with any accounts you may have with
            other services.
          </p>
          ...
          <p>
            ...
            and disclose your personal information in accordance with this privacy policy. You do not have
            to provide personal information to us, however, if you do not, it may affect your use of our
          ...
          <ul>
            ...
            <li>Notification of data breaches: We will comply with laws applicable to us in respect of any data breach.</li>
            <li>
              Complaints: If you believe that we have breached a relevant data protection law and wish to
              make a complaint, please contact us using the details below and provide us with full details
              of the alleged breach. We will promptly investigate your complaint and respond to you, in
            ...
            <li>
              ...
              marketing communications), please contact us using the details provided in this privacy
          ...
          <p>
            Please refer to our <Link to="/legal/cookies">Cookie Policy</Link> for more information.
          </p>
          ...
          <p>
            ...
            your personal information according to this policy, which they will be required to assume as it
          ...
          <p>
            ...
            behalf of other organizations (known as "data processors"). We, Overmind Labs, are a Data
          ...
          <p>
            ...
            and use your information on the following grounds: consent from you, performance of a contract
            or transaction, our legitimate interests, and compliance with law.
          </p>
          ...
          <p>
            You may have the right to restrict processing, object to processing, request a copy of your
            personal information (data portability), and request deletion of your personal information. If
            you ask us to delete your personal information, we will let you know how the deletion affects
            your use of our website or products and services. If you terminate or delete your account, we
            will delete your personal information within 14 days of the deletion of your account.
          </p>
          ...
          <p>
            ...
            request once every calendar year.
          </p>
          <h3>Do Not Track</h3>
          <p>
          ...
          <ul>
            <li>Identifiers (such as real name, alias, or email address)</li>
          </ul>
          <h3>Right to Know and Delete</h3>
          <p>
            If you are a California resident, you have rights to delete your personal information we
            collected and know certain information about our data practices in the preceding 12 months. In
          ...
          <ul>
            <li>martin@evilmasterplan.net</li>
          </ul>
        </div>
      </div>
    </>
